   ...
   if (message.content === prefix + "E7 faq"){
	...
	message.channel.sendEmbed(embed)
        ...
        const UserInfo = new Discord.MessageEmbed()
            ...
            .addField('Dernier message', message.author.lastMessage) //The Message object of the last message sent by the user, if one was sent
            .addField('ID du dernier message', message.author.lastMessageID) //The ID of the last message sent by the user, if one was sent
            .addField('Présente ?', message.author.presence) //The presence of this user
            .addField('Présent', message.author.presence.status) //The presence status of this user
            .addField('Joue à', message.author.presence.activity.name) //The presence Game of this user
            .addField('Tag', message.author.tag) //The Discord "tag" for this user || Ex:- Sai Chinna#6718
            .addField('Pseudo', message.author.username) //The username of the user || Ex:- Sai Chinna
