...
bot.on("message", async message => {
 ...
 let quiz = [
    ...
    { q: 'De quel personnage cette phrase est-elle issue: I will... never miss !', a: ['Tywin'] },
    { q: 'De quel personnage cette phrase est-elle issue: You pitiful beings... death is your repentance !', a: ['Diene'] },
    { q: 'De quel personnage cette phrase est-elle issue: The path once tread by the Goddess... **will be covered with your blood !**', a: ['Clarissa'] },
    { q: "De quel personnage cette phrase est-elle issue: I'll kill you, and you, and you ! HAAHAHAHAHAHAHA", a: ['Clarissa'] },
    { q: 'De quel personnage cette phrase est-elle issue: Dancing blade !', a: ['Vildred'] },
    ...
    { q: 'De quel personnage cette phrase est-elle issue: This will be the last moon they see.', a: ['Kise'] },
    { q: "De quel personnage cette phrase est-elle issue: I can't stop now !", a: ['Sez'] },
    { q: "De quel personnage cette phrase est-elle issue: A roaming heart, forever wandering.", a: ['Kayron'] },
    { q: 'De quel personnage cette phrase est-elle issue: Ashes to ashes, dust to dust.', a: ['Kayron'] },
    { q: "De quel personnage cette phrase est-elle issue: I present to you, the greatest magic.", a: ['Bellona'] },
    { q: "De quel personnage cette phrase est-elle issue: Hello ! It's me, ||Yuna|| !", a: ['Yuna'] },
    { q: 'De quel personnage cette phrase est-elle issue: With the light, disappear.', a: ['Ludwig'] },
    { q: "De quel personnage cette phrase est-elle issue: Didn't I tell you? Just put your faith in me.", a: ['Vildred'] },
    { q: "De quel personnage cette phrase est-elle issue: I wanna save the world with the mercy of healing", a: ['Achates'] },
    { q: "De quel personnage cette phrase est-elle issue: I'm still not strong enough but i'll keep doing my best.", a: ['Achates'] },
    ...
    { q: "De quel personnage cette phrase est-elle issue: The lady of the swamp has arrived !", a: ['Charlotte'] },
    { q: "De quel personnage cette phrase est-elle issue: My Goddess... give me the power to vanquish the evil.", a: ['Diene'] },
    { q: 'De quel personnage cette phrase est-elle issue: May these evils... be punished.', a: ['Diene'] },
    { q: "De quel personnage cette phrase est-elle issue: My lady... Stop calling me **fool** !", a: ['Baal & Sezan', 'baal et sezan'] },
    { q: "De quel personnage cette phrase est-elle issue: There is no salvation for those who fall in battle.", a: ['Kayron'] },
    { q: 'De quel personnage cette phrase est-elle issue: Everything disappears.', a: ['Kayron'] },
    { q: "De quel personnage cette phrase est-elle issue: You can't hide from my gun.", a: ['Schuri'] },
    { q: "De quel personnage cette phrase est-elle issue: Shadows, fall.", a: ['Ludwig'] },
    { q: 'De quel personnage cette phrase est-elle issue: Shall we begin the fireworks show ?', a: ['Serila'] },
    { q: "De quel personnage cette phrase est-elle issue: The hell scythe will slice you in two !", a: ['Haste'] },
    ...
    { q: "De quel personnage cette phrase est-elle issue: Alright. Shall we clean up.", a: ['Vildred'] },
    ...
    { q: "De quel personnage cette phrase est-elle issue: Aaaah ! This is my victory.", a: ['Vildred'] },
    { q: "De quel personnage cette phrase est-elle issue: Queen Ceci...please dont leave me.", a: ['Shadow Rose', 'Ml Rose'] },
    { q: "De quel personnage cette phrase est-elle issue: Aaaah ! Blade Ascent !", a: ['Vildred'] },
    { q: "De quel personnage cette phrase est-elle issue: Haha. Ups. Sorry. Sorry... my bad.", a: ['Vildred'] },
    { q: "De quel personnage cette phrase est-elle issue: For Queen Ceci !", a: ['Shadow Rose', 'Ml Rose'] },
    { q: "De quel personnage cette phrase est-elle issue: Oh ! You need my help ! Cool let's go !", a: ['Yufine'] },
    { q: "De quel personnage cette phrase est-elle issue: Victory is always mine !", a: ['Yufine'] },
    { q: "De quel personnage cette phrase est-elle issue: Burn ! Bye bye !", a: ['Aramintha'] },
    { q: "De quel personnage cette phrase est-elle issue: Rest in peace.", a: ['Aramintha'] },
    { q: "De quel personnage cette phrase est-elle issue: Please to meet you. Let's work together.", a: ['Aramintha'] },
    { q: "De quel personnage cette phrase est-elle issue: Leave it to me!", a: ['Aramintha', 'Tywin'] },
    { q: "De quel personnage cette phrase est-elle issue: Bring in on.", a: ['Aramintha'] },
    { q: "De quel personnage cette phrase est-elle issue: Shall we begin.", a: ['Aramintha'] },
    { q: "De quel personnage cette phrase est-elle issue: I will continue to do my best.", a: ['Tywin'] },
    { q: "De quel personnage cette phrase est-elle issue: Please forgive me.", a: ['Tywin'] },
    { q: "De quel personnage cette phrase est-elle issue: I'm always ready.", a: ['Tywin'] },
    { q: "De quel personnage cette phrase est-elle issue: Thank you. I will keep doing my best.", a: ['Cecilia'] },
    { q: "De quel personnage cette phrase est-elle issue: I am ||Cecilia||, please feel free call me ||Ceci||.", a: ['Cecilia'] },
    { q: "De quel personnage cette phrase est-elle issue: I will break you, I won’t be defeated", a: ['Cecilia'] },
    { q: "De quel personnage cette phrase est-elle issue: Lance of Steel, now it’s time of judgment !", a: ['Cecilia'] },
    { q: "De quel personnage cette phrase est-elle issue: Dissapear, get out of my way !", a: ['Cecilia'] },
    { q: "De quel personnage cette phrase est-elle issue: I will be victorious.", a: ['Cecilia'] },
    { q: "De quel personnage cette phrase est-elle issue: Now it's the time of judgment.", a: ['Cecilia'] },
    { q: "De quel personnage cette phrase est-elle issue: Light. Life.", a: ['Angelica'] },
    { q: "De quel personnage cette phrase est-elle issue: All is as the Goddess wills it", a: ['Angelica'] },
    { q: "De quel personnage cette phrase est-elle issue: Sense it's be a while, take care of me.", a: ['Angelica'] },
    { q: "De quel personnage cette phrase est-elle issue: Oh no. I lost. Well it can be out.", a: ['Angelica'] },
    { q: "De quel personnage cette phrase est-elle issue: The Goddess wills it.", a: ['Angelica'] },
    { q: "De quel personnage cette phrase est-elle issue: I'll do my best !", a: ['Montmorancy'] },
    { q: "De quel personnage cette phrase est-elle issue: Do you need some help ?", a: ['Montmorancy'] },
    { q: "De quel personnage cette phrase est-elle issue: We still have time to recover. Let's try again !", a: ['Ras'] },
    { q: "De quel personnage cette phrase est-elle issue: By my command... Victory", a: ['Ras'] },
    { q: "De quel personnage cette phrase est-elle issue: You can't escape !", a: ['Ras'] },
    { q: "De quel personnage cette phrase est-elle issue: I can't lose !", a: ['Ras'] },
    { q: "De quel personnage cette phrase est-elle issue: I take you on.", a: ['Ras'] },
    { q: "De quel personnage cette phrase est-elle issue: Fate is on my side.", a: ['Ras'] },
    { q: "De quel personnage cette phrase est-elle issue: Yameteeeee !", a: ['Dizzy'] },
    { q: "De quel personnage cette phrase est-elle issue: Look at my sword, not my face.", a: ['Violet'] },
    { q: "De quel personnage cette phrase est-elle issue: I know I’m beautiful.", a: ['Violet'] },
    { q: "De quel personnage cette phrase est-elle issue: Be greatfull that you can fight with me.", a: ['Violet'] },
    { q: "De quel personnage cette phrase est-elle issue: My sword will pierce your heart.", a: ['Violet'] },
